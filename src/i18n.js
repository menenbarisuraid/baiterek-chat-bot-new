...
const resources = {
    kk: {
        translation: {
            ...
            placeholderDefault: "Алдымен компания мен қызметкерді таңдаңыз",
    ...
    ru: {
        translation: {
            ...
            placeholderDefault: "Сначала выберите компанию и сотрудника",
    ...
    en: {
        translation: {
            ...
            placeholderDefault: "First select company & employee",
