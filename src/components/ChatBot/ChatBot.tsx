...
// import { fetchAuthSession , AuthUser , getCurrentUser} from 'aws-amplify/auth';
...
//         role = groups.join(","); // превращаем в строку
//       }
...
/// --------------- here i divided it by components
    ...
    <div className={styles.page}>
      ...
      <main className={styles.body}>
        <section className={styles.card}>
          ...
          <MessageList
            dialog={dialog}
            placeholderText={t("placeholderDefault")}
          />
